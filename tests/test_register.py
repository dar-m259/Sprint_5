...
class TestRegistration:
    def test_register_password_6_or_more_success(self, register_page, generate_email, generate_password):
    ...
    def test_register_password_less_than_6_shows_error(self, register_page, generate_email, generate_incorrect_password):
        driver = register_page
