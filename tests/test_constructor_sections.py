...
def test_constructor_sections_select_buns_is_selected(logged_in_driver):
...
def test_constructor_sections_select_sauces_is_selected(logged_in_driver):
    logged_in_driver.find_element(*ConstructorLocators.SAUCES_SECTION).click() #Раздел "Соусы"
...
def test_constructor_sections_select_fillings_is_selected(logged_in_driver):
