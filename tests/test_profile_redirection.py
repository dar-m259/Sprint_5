...
def test_profile_redirection_click_constructor_shows_constructor(logged_in_driver):
    #Авторизироваться
...
def test_profile_redirection_click_logo_shows_constructor(logged_in_driver):
    #Авторизироваться
    #Кликнуть на "Личный кабинет"
    logged_in_driver.find_element(*MainPageLocators.PROFILE_LINK).click() #Гиперссылка "Личный кабинет"
