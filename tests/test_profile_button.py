...
class TestProfileButton:
    def test_profile_button_click_authorized_shows_profilepage(self, logged_in_driver):
        #Авторизироваться
    ...
    def test_profile_button_click_unauthorized_shows_loginpage(self, main_page):
        driver = main_page
